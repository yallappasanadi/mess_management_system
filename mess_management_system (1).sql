-- Mess Management System SQL (College project - human style)
-- File: mess_management_system.sql
...
-- Sample students (a realistic batch)
...
-- Attendance sample for November 2025 (a few realistic entries)
...
-- More attendance to mimic a month (few random entries)
...
-- Simple reports (human style, not too fancy)

-- 1) Total meals taken by each student in November 2025
...
-- 3) Simple billing: sum default costs (ignores special overrides)
